...
namespace ERPCubes.Persistence.Repositories.CRM
{
    public class LeadRepository : BaseRepository<CrmLead>, IAsyncLeadRepository
    {
        ...
        public async Task<List<GetCheckPointLeadVm>> GetCheckPoint(GetCheckPointLeadQuery request)
        {
            try
            {
        ...
        public async Task SetCheckPointStatus(SetCheckPointStatusCommand request)
        {
            try
            {
                ...
                if (existing == null)
                {
                    ...
                    chkL.CompletedBy=request.Id;
                    chkL.CompletedOn= DateTime.Now.ToUniversalTime();
                ...
                {
                    if (existing != null && existing.CompletedOn!=null && existing.CompletedBy!=null)
                    {
